...
state_type ODE_system::_class_parameter = state_type(150, 0);

void ODE_system::setup_class_parameters(Param& param){
    //mAPC_Endo, mwe9254256_3b91_4192_b9e3_7753526c09c8, index: 0
    //Unit: metre^(3)
    _class_parameter[0] = PFILE(9) * 0.0010000000000000007;
    //mAPC_Surf, mw8206551f_afae_4be9_be2e_5655366de25e, index: 1
    //Unit: metre^(2)
    ...
    //Unit: metre^(3)
    _class_parameter[18] = PFILE(78) * 0.0010000000000000007;
    ...
    //n_aT_prolif_TCR0, mwb2e6a581_05fc_4433_8533_2ac8c1fdb553, index: 131
    //Unit: dimensionless^(1)
    _class_parameter[131] = PFILE(213) * 1.0;
    //n_aT_prolif_IL20, mw8256e539_1467_4190_96d4_947ccdcd04f7, index: 132
    //Unit: dimensionless^(1)
    _class_parameter[132] = PFILE(214) * 1.0;
    //n_aT_prolif_Coestim0, mw7b7b8f32_a479_400d_8b7a_ad1f061fd0ef, index: 133
    //Unit: dimensionless^(1)
    _class_parameter[133] = PFILE(215) * 1.0;
    //K_IL2_Teff, mwde9ecd9a_9f1b_4d51_a53e_d134b3348896, index: 134
    //Unit: metre^(-3)mole^(1)
    _class_parameter[134] = PFILE(216) * 1.0000000000000008e-06;
    //k_IL2_rel, mwd137168f_f48e_4fa9_b81f_82ea1fd94292, index: 135
    //Unit: second^(-1)
    _class_parameter[135] = PFILE(217) * 167281721944.444;
    //k_IL2_deg, mw7ef5bcec_f071_4605_831a_872aba02b16f, index: 136
    //Unit: second^(-1)
    _class_parameter[136] = PFILE(218) * 0.0166666666666667;
    //k_IL2_consump, mw6a81469c_969c_4e01_838c_5a47faabdc9f, index: 137
    //Unit: second^(-1)
    _class_parameter[137] = PFILE(219) * 167281721944.444;
    //k_nTCD4_APC, mw34a0a877_c802_4dbb_bef5_9ef62ce1f53a, index: 138
    //Unit: second^(-1)
    _class_parameter[138] = PFILE(224) * 1.15740740740741e-05;
    //n_sites_APC, mwbc9d5a6c_a0ff_403f_8476_78eec4b30888, index: 139
    //Unit: dimensionless^(1)
    _class_parameter[139] = PFILE(225) * 1.0;
    //K_Cp, mw6359ccf3_db09_4e7b_b361_60b496d3cab2, index: 140
    //Unit: metre^(-3)mole^(1)
    _class_parameter[140] = PFILE(226) * 0.0010000000000000005;
    //k_aTreg_prolif, mw1141b6ef_52d2_43e5_bcf0_a3130aac34da, index: 141
    //Unit: second^(-1)
    _class_parameter[141] = PFILE(227) * 1.15740740740741e-05;
    //K_IL2_Treg, mw721d8acc_9984_401a_9459_e8cae982cc78, index: 142
    //Unit: metre^(-3)mole^(1)
    _class_parameter[142] = PFILE(228) * 1.0000000000000008e-06;
    //nTreg_basal, mw41b0ede7_ff51_44a8_91fb_e50878093492, index: 143
    //Unit: mole^(1)
    _class_parameter[143] = PFILE(229) * 1.66053872801495e-24;
    //k_Treg_death, mw4bb29e34_500d_4cdd_a1e8_61e5cc530df4, index: 144
    //Unit: second^(-1)
    _class_parameter[144] = PFILE(230) * 1.15740740740741e-05;
    //k_Treg_egress, mw16d82821_1b4c_4b89_83b4_afe37630fa82, index: 145
    //Unit: second^(-1)
    _class_parameter[145] = PFILE(231) * 1.15740740740741e-05;
    //k_Treg_transmig, mwcd4e98db_1596_40e8_af08_b52086449c00, index: 146
    //Unit: mole^(-1)second^(-1)
    _class_parameter[146] = PFILE(232) * 1.00369033166667e+22;
    //k_Treg_exit, mw674faf4c_a5d6_457a_a4db_eaaf651448c7, index: 147
    //Unit: second^(-1)
    _class_parameter[147] = PFILE(233) * 0.0166666666666667;
    //k_Teff_inhibBy_Treg, mwe684b4c3_6e56_4c8d_a5a2_343a9f8b5b7f, index: 148
    //Unit: second^(-1)
    _class_parameter[148] = PFILE(234) * 1.15740740740741e-05;
    //K_Treg_inhib, mw062a2431_8623_4b64_957b_3934339b4156, index: 149
    //Unit: metre^(-3)mole^(1)
    _class_parameter[149] = PFILE(235) * 999.9999999999994;
}
...
void ODE_system::setup_instance_varaibles(Param& param){
    ...
    //Unit: mole^(1)metre^(-3)
    _species_var[11] = PFILE(25) * 1000.0;
    ...
    //Unit: mole^(1)metre^(-3)
    _species_var[32] = PFILE(48) * 1000.0;
...
void ODE_system::eval_init_assignment(void){
    ...
    realtype AUX_VAR_T_all_Tum = _species_var[23] + _species_var[12];
...
int ODE_system::f(realtype t, N_Vector y, N_Vector ydot, void *user_data){
    ...
    realtype AUX_VAR_T_all_Tum = SPVAR(23) + SPVAR(12);
    ...
    realtype AUX_VAR_n_aT_prolif_TCR = PARAM(131);

    realtype AUX_VAR_n_aT_prolif_IL2 = PARAM(132) * (SPVAR(32) / PARAM(23)) / (SPVAR(32) / PARAM(23) + PARAM(134)) + 0.001;

    realtype AUX_VAR_n_aT_prolif_Coestim = PARAM(133);

    realtype AUX_VAR_n_Treg_prolif_IL2 = PARAM(132) * (SPVAR(32) / PARAM(23)) / (SPVAR(32) / PARAM(23) + PARAM(142));
    ...
    realtype AUX_VAR_S_adhesion = PARAM(129) * AUX_VAR_Tum * SPVAR(7) / PARAM(38);
    ...
    realtype AUX_VAR_clonality = 1.0 + (PARAM(97) * (SPVAR(2) / PARAM(97) / AUX_VAR_T_all_Cent) * log2(SPVAR(2) / PARAM(97) / AUX_VAR_T_all_Cent) + PARAM(117) * (AUX_VAR_nT_CD8 / PARAM(117) / AUX_VAR_T_all_Cent) * log2(AUX_VAR_nT_CD8 / PARAM(117) / AUX_VAR_T_all_Cent)) / log2(PARAM(117) + PARAM(97));
	...
	realtype ReactionFlux5 = 0;// -PARAM(37) * SPVAR(7) * (1.0 - SPVAR(7) / PARAM(38)) + PARAM(39) * SPVAR(7) + PARAM(40) * SPVAR(7) * SPVAR(23) / (SPVAR(7) + AUX_VAR_T_all_Tum) * (0.0 + 1.0 - std::pow((SPVAR(20) + SPVAR(21)) / PARAM(77), PARAM(80)) / (std::pow((SPVAR(20) + SPVAR(21)) / PARAM(77), PARAM(80)) + 1.0)) + PARAM(42) * SPVAR(7) * PARAM(41);
    ...
    realtype ReactionFlux47 = PARAM(135) * SPVAR(35);

    realtype ReactionFlux48 = PARAM(136) * SPVAR(32) * AUX_VAR_LN;

    realtype ReactionFlux49 = PARAM(137) * SPVAR(30) * (SPVAR(32) / PARAM(23) / (PARAM(142) + SPVAR(32) / PARAM(23)));

    realtype ReactionFlux50 = PARAM(137) * SPVAR(35) * (SPVAR(32) / PARAM(23) / (PARAM(134) + SPVAR(32) / PARAM(23)));
    ...
    realtype ReactionFlux54 = PARAM(122) / AUX_VAR_n_aT_prolif * SPVAR(35);

    realtype ReactionFlux55 = PARAM(122) / AUX_VAR_n_aT_prolif * std::pow(2.0, AUX_VAR_n_aT_prolif) * SPVAR(35);
    ...
    realtype ReactionFlux59 = PARAM(127) * AUX_VAR_S_adhesion * SPVAR(2) * AUX_VAR_Tum * SPVAR(7) / PARAM(38) * PARAM(24) / AUX_VAR_Cent;
    ...
    realtype ReactionFlux62 = PARAM(123) * SPVAR(24);
    ...
    realtype ReactionFlux68 = PARAM(138) * PARAM(96) * (SPVAR(29) / PARAM(118)) * (PARAM(139) * SPVAR(26) / (PARAM(139) * SPVAR(26) + SPVAR(29) / PARAM(118))) * (AUX_VAR_cpt_M / PARAM(96) / (AUX_VAR_cpt_M / PARAM(96) + PARAM(121)));

    realtype ReactionFlux69 = PARAM(141) / AUX_VAR_n_Treg_prolif_IL2 * SPVAR(30);

    realtype ReactionFlux70 = PARAM(141) / AUX_VAR_n_Treg_prolif_IL2 * std::pow(2.0, AUX_VAR_n_Treg_prolif_IL2) * SPVAR(30);

    realtype ReactionFlux71 = PARAM(144) * SPVAR(31);

    realtype ReactionFlux72 = PARAM(145) * SPVAR(31);

    realtype ReactionFlux73 = PARAM(144) * SPVAR(1);

    realtype ReactionFlux74 = PARAM(144) * PARAM(143);

    realtype ReactionFlux75 = PARAM(146) * AUX_VAR_S_adhesion * SPVAR(1) * AUX_VAR_Tum * SPVAR(7) / PARAM(38) * PARAM(24) / AUX_VAR_Cent;

    realtype ReactionFlux76 = PARAM(144) * SPVAR(12);

    realtype ReactionFlux77 = PARAM(146) * AUX_VAR_S_adhesion_peri * SPVAR(1) * AUX_VAR_Peri * PARAM(24) / AUX_VAR_Cent;

    realtype ReactionFlux78 = PARAM(147) * SPVAR(4);

    realtype ReactionFlux79 = PARAM(144) * SPVAR(4);

    realtype ReactionFlux80 = PARAM(148) * SPVAR(23) * (SPVAR(12) / (SPVAR(7) + AUX_VAR_T_all_Tum)) * (1.0 + std::pow((SPVAR(20) + SPVAR(21)) / PARAM(77), PARAM(80)) / (std::pow((SPVAR(20) + SPVAR(21)) / PARAM(77), PARAM(80)) + 1.0));
...
bool ODE_system::eventExecution(int i, bool delayed, realtype& dt){
    ...
    case 1:
        ...
        break;
    case 2:
        NV_DATA_S(_y)[7] = _class_parameter[48];
        NV_DATA_S(_y)[23] = _class_parameter[49];
        NV_DATA_S(_y)[12] = _class_parameter[50];
        break;
    case 3:
